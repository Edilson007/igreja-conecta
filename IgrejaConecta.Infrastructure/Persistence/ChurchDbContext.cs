...
public sealed class MassScheduleRecord { public int Id { get; set; } public Guid ParishId { get; set; } public string Day { get; set; } = string.Empty; public string Time { get; set; } = string.Empty; public string? Description { get; set; } }
